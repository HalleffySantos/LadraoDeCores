...
public class Pergaminho : MonoBehaviour, IInteracao
{
    ...
    {
        nodeParser = GameObject.FindGameObjectWithTag(GameObjectsTags.NodeParserPergaminhoTag.Value).GetComponent<INodeParser>();
        caixaDeDialogo = GameObject.FindGameObjectWithTag(GameObjectsTags.CaixaPergaminhoTag.Value).GetComponent<ICaixaDeDialogo>();
